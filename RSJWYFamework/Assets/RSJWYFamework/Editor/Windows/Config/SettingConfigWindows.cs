...
namespace RSJWYFamework.Editor.Windows.Config
{
    ...
    public class SettingConfigWindows:OdinMenuEditorWindow
    {
        ...
        protected override OdinMenuTree BuildMenuTree()
        {
            ...
            tree.AddAllAssetsAtPath("运行时配置", "Assets/Resources", typeof(ScriptableObject), false);
            tree.AddAllAssetsAtPath("Yoo内置清单", "Assets/Resources/ImportantData", typeof(ScriptableObject), true);
            return tree;
        }
    }
}