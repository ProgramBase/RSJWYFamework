...
namespace RSJWYFamework.Editor.Windows.HybridCLR
{
    ...
    public class HybridCLRToolWindows : OdinEditorWindow
    {
        ...
        {
            Utility.FileAndFolder.ClearDirectory($"{UtilityEditor.UtilityEditor.GetProjectPath()}{SettingData.BuildMetadataForAOTAssembliesDllPatch}");
        ...
        {
            Utility.FileAndFolder.ClearDirectory($"{UtilityEditor.UtilityEditor.GetProjectPath()}{SettingData.BuildHotCodeDllPatch}");
            AssetDatabase.Refresh();
