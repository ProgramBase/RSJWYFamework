...
namespace RSJWYFamework.Runtime.StateMachine
{
    ...
    public class StateMachineController
    {
        ...
        /// 所属使用者
        /// </summary>
        public IStateMachineUser User { get; private set; }
        
        /// <summary>
        /// 当前流程
        /// </summary>
        private StateNodeBase _currentStateNodeBase;
        ...
        public StateMachineController(IStateMachineUser module,string name,string otherInfo="")
        {
            this.User = module;
            this.Name = name;
        ...
        {
            _currentStateNodeBase?.OnUpdate();
        }
        /// <summary>
        /// 秒更新
        /// </summary>
        ...
        {
            _currentStateNodeBase?.OnUpdateSecond();
        }
        ...
        {
            return _currentStateNodeBase.GetType();
        }
        /// <summary>
        /// 切换到指定流程
        /// </summary>
        /// <typeparam name="TProcedureBase">流程类型</typeparam>
        public void SwitchProcedure<TProcedureBase>() where TProcedureBase : StateNodeBase
        {
        ...
        public void SwitchProcedure(Type type)
        {
            ...
            {
                if (_currentStateNodeBase == Procedures[type])
                    return;

                var lastProcedure = _currentStateNodeBase;
                var nextProcedure = Procedures[type];
                if (lastProcedure != null)
                {
                    lastProcedure.OnLeave(nextProcedure);
                }
                _currentStateNodeBase = nextProcedure;
        ...
        {
            int index = ProcedureTypes.IndexOf(_currentStateNodeBase.GetType());
        ...
        /// 添加一个流程
        /// </summary>
        /// <param name="stateNodeBase"></param>
        /// <exception cref="RSJWYException"></exception>
        public void AddProcedure(StateNodeBase stateNodeBase)
        {
            Type _t = stateNodeBase.GetType();
            ...
            {
                Procedures.Add(_t, stateNodeBase);
                ProcedureTypes.Add(_t);
                stateNodeBase.pc = this;
                stateNodeBase.OnInit();
            }
            else
            {
        ...
        /// <exception cref="RSJWYException"></exception>
        public void AddProcedure<TProcedureBase>() where TProcedureBase : StateNodeBase,new()
        {
        ...
        public void RemoveProcedure(Type type)
        {
            if (!Procedures.TryGetValue(type,out var procedure))
            {
                ...
                if (_currentStateNodeBase == procedure)
                {
                    _currentStateNodeBase = null;
                }
            }
            else
            {
